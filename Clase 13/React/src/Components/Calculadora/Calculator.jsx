...
return (
    <div>
        ...
        <form action="" onSubmit={handleSubmitCalculatorForm}>
            ...
            <input type="numero" name='numero_1' id='numero_1' value={calculatorForm.numero_1} onChange={handleChangeCalculatorInput}/>
            <label htmlFor="numero_2"> Ingrese el primer numero</label>
            <input type="numbero" name='numero_2' id='numero_2' value={calculatorForm.numero_2} onChange={handleChangeCalculatorInput} />
            <div>
